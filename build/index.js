...
function SkillBar(props) {
  return e('div', { className: 'skill_subcontainer' }, e('img', { className: 'bar_image', src: 'img/' + props.container_id + '.png' }, null));
}

function SkillsPanel() {
  return e('div', { id: 'skills_container' }, e('h2', { className: 'container_title_h2' }, 'Programming Languages'), e(SkillBar, { container_id: 'pythonbar' }, null), e(SkillBar, { container_id: 'javabar' }, null), e(SkillBar, { container_id: 'javascriptbar' }, null), e(SkillBar, { container_id: 'reactbar' }, null), e(SkillBar, { container_id: 'html5bar' }, null), e(SkillBar, { container_id: 'css3bar' }, null), e(SkillBar, { container_id: 'mysqlbar' }, null), e('h2', { className: 'container_title_h2' }, 'Spoken Languages'), e(SkillBar, { container_id: 'englishbar' }, null), e(SkillBar, { container_id: 'spanishbar' }, null), e(SkillBar, { container_id: 'catalanbar' }, null));
}
...
function MainPanel(props) {
  switch (props.name) {
    case 'self':
      // MYSELF panel text
      return e('div', { className: 'info_subcontainer', id: 'self_selected' }, e('h1', { className: 'container_title' }, 'HTML5'), e('div', { className: 'text_inbox' }, e('p', {}, 'Hi! My name is Sergio Giraldez from Barcelona. I am a passionate software developer aiming to put my skills to test. I love challenge and learning, I made this Web Curriculum to improve my React, html5 & css3 abilities.')), e(SkillsPanel, {}, null));
    case 'studies':
...
var ContentManager = function (_React$Component) {
  ...
  _createClass(ContentManager, [{
    ...
    value: function render() {
      return e('div', { id: 'container' }, e('div', { id: 'button_container' }, e(Button, { handleClick: this.changeToMyself, name: 'myselfbtn', txt: 'MYSELF', clas: this.state.value }, null), e(Button, { handleClick: this.changeToMystudies, name: 'studiesbtn', txt: 'STUDIES', clas: this.state.value }, null), e(Button, { handleClick: this.changeToMycareer, name: 'careerbtn', txt: 'CAREER', clas: this.state.value }, null)), e('div', { id: 'info_container' }, e(MainPanel, { name: this.state.value }, null)));
    }
  }]);
